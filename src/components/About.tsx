        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-4xl md:text-5xl text-slate-900 mb-2">
                  {stat.number}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <p className="text-blue-600 mb-4 tracking-wider">CHI SONO</p>
              <h2 className="text-4xl md:text-5xl text-slate-900 mb-8">
                Passione per la tecnologia, <span className="text-blue-600">esperienza sul campo</span>
              </h2>
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="group p-6 bg-slate-50 hover:bg-blue-50 rounded-2xl transition-all"
                >
                  <item.icon className="w-8 h-8 text-blue-600 mb-4" />
                  <h3 className="text-lg text-slate-900 mb-1">{item.title}</h3>
