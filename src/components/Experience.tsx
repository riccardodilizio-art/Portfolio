  ...
  const experiences = [
    {
      ...
      description: 'Gestione completa di servizi di cronometraggio elettronico per eventi sportivi con tecnologia Race Result.',
      achievements: [
    ...
    },
    {
      ...
      description: 'Esperienza professionale internazionale in ambiente multiculturale con focus su tecnologie IT.',
      achievements: [
  ...
  return (
    <section id="experience" ref={ref} className="py-32 px-6 bg-slate-50">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="mb-16">
            <p className="text-blue-600 mb-4 tracking-wider">ESPERIENZA</p>
          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              <motion.div
                ...
                className="group bg-white rounded-3xl p-8 md:p-10 hover:shadow-xl transition-all"
              >
                <div className="flex flex-col md:flex-row gap-8">
                  ...
                  <div className="flex-grow">
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-4">
                      <div>
                        <h3 className="text-2xl md:text-3xl text-slate-900 mb-2">{exp.title}</h3>
