      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="text-center mb-16">
            <p className="text-blue-600 mb-4 tracking-wider">VALORI</p>
            ...
            {values.map((value, index) => (
              ...
              >
                <div className="h-full bg-white rounded-3xl p-8 hover:shadow-xl transition-all">
                  ...
                  <h3 className="text-2xl text-slate-900 mb-3">{value.title}</h3>
          ...
          >
            <blockquote className="text-2xl md:text-3xl text-slate-900 italic leading-relaxed">
